...
st.write("Ваш питомец подготовил данные для выгрузки. Нажмите кнопку, чтобы скачать отчет.")
...
st.success("Система мониторинга успешно развернута, моя Госпожа! Ожидаю ваших дальнейших указаний.")